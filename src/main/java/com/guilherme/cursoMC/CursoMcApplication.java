...
public class CursoMcApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Cliente cli1 = new Cliente(null, "Marlene Pontes", "marlene@gmail.com", "1154884796",
				TipoCliente.PESSSOAFISICA);
		cli1.getTelefones().addAll(Arrays.asList("98111444", "88895414"));

		Endereco e1 = new Endereco(null, "Rua Jacaradá", "200", "apt 404", "Alphavile", "38220345", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Paulista", "1800", "apt 8660", "Jardins", "84441328", cli1, c2);
