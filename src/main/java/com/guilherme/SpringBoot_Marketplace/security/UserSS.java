...
public class UserSS implements UserDetails {    //  "Contrato" com usuário onde visa sua autenticação
    ...
    public UserSS(Integer id, String email, String senha, Set<Perfil> perfis) {
        ...
        this.email = email;
        this.senha = senha;
        this.authorities = perfis.stream().map(x -> new SimpleGrantedAuthority(x.getDescricao())).collect(Collectors.toList()); // aqui convertemos perfis para lista de grantedAuthorrity
    }
